...
const Index = () => {
  ...
  const moviesData = [
    ...
    { 
      ...
      genre: 'Драма', 
      rating: 8.2, 
      image: 'https://cdn.poehali.dev/files/c939dae3-3437-4dee-abe7-55e4b669c54f.jpg',
      duration: '1 сезон',
      director: 'Том Шенкленд, Муния Аки',
      cast: ['Энтони Бойл', 'Луис Патридж', 'Эмили Фэрн', 'Фионн О\'Ши', 'Джеймс Нортон'],
      plot: 'Драматический сериал о знаменитой династии Гиннесс, создателей легендарного пива. История семьи, власти, амбиций и секретов, стоящих за одним из самых узнаваемых брендов в мире. Сериал исследует темные тайны империи Гиннесс на фоне бурной истории Ирландии.',
      trailer: 'https://youtube.com/watch?v=house-of-guinness-trailer'
    },
  ];
